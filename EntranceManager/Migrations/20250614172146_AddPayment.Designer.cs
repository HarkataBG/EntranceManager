...
namespace EntranceManager.Migrations
{
    ...
    [Migration("20250614172146_AddPayment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entrance", b =>
                {
                    ...
                    b.Property<bool>("CountChildrenAsResidents")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("EntranceManager.Models.ApartmentFee", b =>
                {
                    ...
                    b.Property<decimal>("AmountForApartment")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("EntranceManager.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntranceManager.Models.Payment", b =>
                {
                    b.HasOne("EntranceManager.Models.ApartmentFee", "ApartmentFee")
                        .WithMany("Payments")
                        .HasForeignKey("ApartmentFeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ApartmentFee");
                });
